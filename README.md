...
- `Ctrl+Pause` (`CP`) - умная конвертация текущей строки до курсора: ищет только подозрительные слова во фразе и не трогает корректный русский/английский текст или текст справа от курсора.
